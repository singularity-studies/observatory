...
The schema bundle also contains ten contracts for prospectively constructing,
reviewing, and locking a Domain Universe. These cover the boundary, source
frames, source-entry extraction and normalization ledger, domain candidates,
deterministic eligibility, relations, proposal, scientific review, governance
decision, and final manifest. The existing
